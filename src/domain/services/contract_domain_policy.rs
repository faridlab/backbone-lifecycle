//! Domain policy for Contract aggregate
//!
...
/// Domain policy for Contract — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<Contract>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type ContractDomainPolicy = PermitAllPolicy<Contract>;
