//! Domain policy for ContractTemplate aggregate
//!
...
/// Domain policy for ContractTemplate — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<ContractTemplate>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type ContractTemplateDomainPolicy = PermitAllPolicy<ContractTemplate>;
