//! Domain policy for OnboardingTemplate aggregate
//!
...
/// Domain policy for OnboardingTemplate — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<OnboardingTemplate>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type OnboardingTemplateDomainPolicy = PermitAllPolicy<OnboardingTemplate>;
