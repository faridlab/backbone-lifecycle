//! Domain policy for OnboardingTemplateTask aggregate
//!
...
/// Domain policy for OnboardingTemplateTask — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<OnboardingTemplateTask>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type OnboardingTemplateTaskDomainPolicy = PermitAllPolicy<OnboardingTemplateTask>;
