//! Specifications for ClearanceItem aggregate
//!
...
// Each predicate implements `Specification<ClearanceItem>` and can be combined
...
//
// pub struct ActiveClearanceItemSpec;
// impl Specification<ClearanceItem> for ActiveClearanceItemSpec {
//     fn is_satisfied_by(&self, e: &ClearanceItem) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
