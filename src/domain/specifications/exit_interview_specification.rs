//! Specifications for ExitInterview aggregate
//!
...
// Each predicate implements `Specification<ExitInterview>` and can be combined
...
//
// pub struct ActiveExitInterviewSpec;
// impl Specification<ExitInterview> for ActiveExitInterviewSpec {
//     fn is_satisfied_by(&self, e: &ExitInterview) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
