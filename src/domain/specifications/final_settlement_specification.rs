//! Specifications for FinalSettlement aggregate
//!
...
// Each predicate implements `Specification<FinalSettlement>` and can be combined
...
//
// pub struct ActiveFinalSettlementSpec;
// impl Specification<FinalSettlement> for ActiveFinalSettlementSpec {
//     fn is_satisfied_by(&self, e: &FinalSettlement) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
