//! Specifications for Onboarding aggregate
//!
...
// Each predicate implements `Specification<Onboarding>` and can be combined
...
//
// pub struct ActiveOnboardingSpec;
// impl Specification<Onboarding> for ActiveOnboardingSpec {
//     fn is_satisfied_by(&self, e: &Onboarding) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
