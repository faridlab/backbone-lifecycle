//! Specifications for OnboardingTask aggregate
//!
...
// Each predicate implements `Specification<OnboardingTask>` and can be combined
...
//
// pub struct ActiveOnboardingTaskSpec;
// impl Specification<OnboardingTask> for ActiveOnboardingTaskSpec {
//     fn is_satisfied_by(&self, e: &OnboardingTask) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
