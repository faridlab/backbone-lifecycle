...
//!
//! Tests the Onboarding CRUD API endpoints.
...
/// Test data generator for Onboarding
pub struct OnboardingTestData;

impl TestDataGenerator for OnboardingTestData {
...
pub struct OnboardingApiTest {
    inner: GenericCrudTest<OnboardingTestData>,
}

impl OnboardingApiTest {
    pub fn new() -> Self {
        let mut config = CrudTestConfig::new("/api/v1/onboardings", "Onboarding");
        config.supports_soft_delete = true;
        Self {
            inner: GenericCrudTest::new(config, OnboardingTestData),
        }
    }
...
impl Default for OnboardingApiTest {
    fn default() -> Self {
        Self::new()
    }
}
...
// <<< CUSTOM TESTS START >>>
// Add Onboarding specific tests here
// <<< CUSTOM TESTS END >>>
